...
| [0010](0010-phase2-engineering-layer.md) | Phase 2 engineering layer and method defaults | Accepted |
| [0011](0011-in-house-rainflow.md) | In-house index-preserving rainflow counting | Accepted |
| [0012](0012-currency-flags.md) | Currency flags to re-check after 2026-06-24 | Accepted |
