...
\section{Variable-amplitude local strain simulation, experimental}
...
construction and by test, and it is experimental until validated against a
published variable-amplitude dataset. References: Masing 1926 (Proc.\ 2nd
...
Variable-amplitude simulation (experimental) & & \\
